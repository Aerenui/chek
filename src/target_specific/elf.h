#ifndef SIMPLECOMPILERINC_2_ELF_H
#define SIMPLECOMPILERINC_2_ELF_H

/*
 * COPIED FROM standard elf.h on linux
 * (to be able to compiler compiler on non-linux systems)
 *
 */
...
#endif // SIMPLECOMPILERINC_2_ELF_H