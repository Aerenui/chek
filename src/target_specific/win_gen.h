...
void write_win64(const char*, const uint8_t*, size_t, uint64_t, FunctionsRegistry*, uint64_t str_consts_load_addr, StringViewList* string_consts, uint32_t num_sections, StringViewList importing_funcs, uint64_t import_table_load_addr);
